...
public class MyJDBC02 {
    ...
    public static void main(String[] args) {
        ...
        try{
            ...
            PreparedStatement consultaPreparada = connection.prepareStatement("SELECT * FROM estudiantes WHERE apellido=? AND dni BETWEEN ? AND ? ORDER BY apellido");
//
            /**/
            String consultaSelect = "SELECT * FROM estudiantes";
            ...
            statement.executeUpdate("INSERT INTO estudiantes (dni, nombre, apellido) VALUES (40643843, 'Matías', 'Brest');");
